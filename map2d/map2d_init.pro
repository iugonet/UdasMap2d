...
;    map_time: the time used for drawing map
;    coord: the name of the coordinate system.
;			'geographic' or 0 for geographic coordinate
...
pro map2d_init, reset=reset, map_time=map_time, coord=coord, $
...
;----- set map_time -----;
if keyword_set(map_time) then begin
	map2d_time, map_time, quiet=quiet
endif
